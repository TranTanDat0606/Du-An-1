...
<div class="container">
    ...
    <div class="product-info">
        <div class="product-images">
            <img src="../../image/ảnh 1.jpg" alt="Ảnh 1" />
            <img src="../../image/ảnh 2.jpg" alt="Ảnh 2" />
            <img src="../../image/ảnh 3.jpg" alt="Ảnh 3" />
            <img src="../../image/ảnh 4.png" alt="Ảnh 4" />
        </div>
    ...
    <div class="customer-info">
        <div class="form-header">
            <h2 class="form-title-payment">THÔNG TIN KHÁCH HÀNG</h2>
        </div>
